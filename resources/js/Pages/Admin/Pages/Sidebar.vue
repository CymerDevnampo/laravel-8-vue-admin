    ...
    <div class="navbar-wrapper">
      <div class="m-header">
        <a href="/admin/dashboard/index.html" class="b-brand text-primary">
          ...
          <!-- <img src="/admin/assets/images/logo-dark.svg" alt="" class="logo logo-lg" /> -->
      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item">
            <a href="/admin/dashboard/index.html" class="pc-link"
              ...
              ><span class="pc-mtext">Default</span></a
            >
          </li>
          ...
          <li class="pc-item">
            <a href="/admin/elements/bc_typography.html" class="pc-link">
              <span class="pc-micon"><i class="ti ti-typography"></i></span>
              <span class="pc-mtext">Typography</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="/admin/elements/bc_color.html" class="pc-link">
              <span class="pc-micon"><i class="ti ti-color-swatch"></i></span>
              <span class="pc-mtext">Color</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="/admin/elements/icon-tabler.html" class="pc-link">
          ...
          <li class="pc-item">
            <a class="pc-link" target="_blank" href="/admin/pages/login-v3.html">
              <span class="pc-micon"><i class="ti ti-lock"></i></span>
              <span class="pc-mtext">Login</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="/admin/pages/register-v3.html" target="_blank" class="pc-link">
          ...
          <li class="pc-item">
            <a href="/admin/other/sample-page.html" class="pc-link">
        ...
        <div class="w-100 text-center">
          <div
            class="badge theme-version badge rounded-pill bg-light text-dark f-12"
          ></div>
        </div>
      </div>
    </div>
