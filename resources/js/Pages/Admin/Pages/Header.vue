          ...
          <li class="dropdown pc-h-item">
            ...
            >
              <div class="dropdown-header">
                <a href="#!" class="link-primary float-end text-decoration-underline"
                  >Mark as all read</a
                >
                <h5>
                  All Notification
            ...
            >
              <div class="dropdown-header">
                ...
                >
                  ...
                  <hr />
                  <a href="/admin/application/account-profile-v1.html" class="dropdown-item">
                    <i class="ti ti-settings"></i>
                    <span>Account Settings</span>
                  </a>
                  <a href="/admin/application/social-profile.html" class="dropdown-item">
                    <i class="ti ti-user"></i>
                    <span>Social Profile</span>
                  </a>
                  <a href="/admin/pages/login-v1.html" class="dropdown-item">
